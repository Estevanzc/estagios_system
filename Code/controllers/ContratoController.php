...
final class ContratoController extends Controller {
    ...
    public function save() {
        $id = $_POST["id"];
        $model = new ContratoModel();
        $vo = new ContratoVO($id, $_POST["nome"], $_POST["encaminhamento"], $_POST["area"], $_POST["data_inicio"], $_POST["data_fim"], (int) $_POST["media_final"], $_POST["supervisor"], $_POST["s_cargo"], $_POST["s_telefone"], $_POST["s_email"], $_POST["observacao"], $_POST["encerramento"], (int) $_POST["id_empresa"], (int) $_POST["id_estudante"], (int) $_POST["id_professor"]);
